...
class TechnicianAppointmentsBloc
  ...
  TechnicianAppointmentsBloc() : super(TechnicianAppointmentsInitial()) {
    ...
    on<TechnicianAppointmentsCustomerCardClickedEvent>(
        technicianAppointmentsCustomerCardClickedEvent);
    on<TechnicianAppointmentHomeButtonClickedEvent>(
        technicianAppointmentHomeButtonClickedEvent);
    on<TechnicianAppointmentProfileButtonClickedEvent>(
        technicianAppointmentProfileButtonClickedEvent);
    on<TechnicianAppointInitialEvent>(technicianAppointInitialEvent);
  }

  FutureOr<void> technicianAppointmentsCustomerCardClickedEvent(
      TechnicianAppointmentsCustomerCardClickedEvent event,
      Emitter<TechnicianAppointmentsState> emit) {}
  ...
  FutureOr<void> technicianAppointmentHomeButtonClickedEvent(
      TechnicianAppointmentHomeButtonClickedEvent event,
      Emitter<TechnicianAppointmentsState> emit) {
    emit(TechnicianAppointmentsNavigateHomeState());
  }

  FutureOr<void> technicianAppointmentProfileButtonClickedEvent(
      TechnicianAppointmentProfileButtonClickedEvent event,
      Emitter<TechnicianAppointmentsState> emit) {
    emit(TechnicianAppointmentNavigateProfileState());
  }
}
