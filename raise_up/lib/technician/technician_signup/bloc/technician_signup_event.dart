...
class TechnicianSignupConfirmationPasswordInputEvent extends TechnicianSignupEvent{
  String confirmationPassword;
  TechnicianSignupConfirmationPasswordInputEvent({required this.confirmationPassword});
}
