                    ...
                    child: BlocConsumer<TechnicianSignupBloc, TechnicianSignupState>(
                      listener: (context, state) {
                        if (state is TechnicianSignUpSucessActionState) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Center(child: Text(state.faliure)),
                              width: 200.0, // Width of the snackbar.
                              behavior: SnackBarBehavior.floating,
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  onChanged: (value) {
                                    context.read<TechnicianSignupBloc>().add(TechnicianSignupEmailInputEvent(email: value));
                                  },
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  onChanged: (value) {
                                    context.read<TechnicianSignupBloc>().add(TechnicianSignupNameInputEvent(name: value));
                                  },
                                  decoration: InputDecoration(
                                    filled: true,
                                    fillColor: Color(0xFFEEEEEE),
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  onChanged: (value) {
                                    context.read<TechnicianSignupBloc>().add(TechnicianSignupPasswordInputEvent(password: value));
                                  },
                                  decoration: InputDecoration(
                                    filled: true,
                                    fillColor: Color(0xFFEEEEEE),
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  onChanged: (value) {
                                    context.read<TechnicianSignupBloc>().add(TechnicianSignupConfirmationPasswordInputEvent(confirmationPassword: value));
                                  },
                                  decoration: InputDecoration(
                                    filled: true,
                                    fillColor: Color(0xFFEEEEEE),
                                  ...
                                  validator: (value){
                                    ...
                                    }else if(state is TechnicianSignUpConfarmationPasswordIncorrectState){
                                ...
                                child: TextButton(
                                  onPressed: () {
                                    if (_formKey.currentState?.validate() ??
                                        false) {}
                                    context.read<TechnicianSignupBloc>().add(TechnicianSignupSignupButtonClickedEvent());
                                  },
                                  style: ButtonStyle(
                                    backgroundColor:
